...
- `RepUI.mount()` / `RepUI.unmount()` — безопасная инициализация DOM-фрагментов, включая HTMX/Django-сценарии; распознаются Select, Listbox, Combobox, Menu, Tabs, Dialog, Popover, Command Palette, Tree, Accordion и Switch.
